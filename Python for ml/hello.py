...
## Exception Handling
number=int(input("Enter the number to be divided with: "))
try:
     print(10/number)
...
#raise -> manually throw a exception
...
File Handling
r=open(r"astarr.txt",'a')
r.write("Hi my name is Harpuneet Singh. and now i am appending something")
r.close()
